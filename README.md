...
举个例子，$2^2 = 4$ 或者 $3^3 = 9$ 上过小学的人都能算出来（其实是背出来的），可是，$2.5^{3.2} = ?$ 我们的大脑直接宕机了 —— 别说我们普通人了，数学家的脑子也一样会宕机…… 用电子表格就简单了，无非是 `=power(2.5, 3.2)`，等于 `18.76756928`。在没有电子表格之前，我们就是束手无策啊！
...
当我们想知道如果我要 $n$ 期后得到资金 $m$，那么每个月要投入多少钱 $x$？每月需要投入多少钱，那么，要用 PMT 函数（PMT 是 PayMenT 的缩写）：
